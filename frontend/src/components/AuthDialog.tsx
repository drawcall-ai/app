      ...
      <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4">
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full cursor-pointer flex items-center justify-center px-4 py-3 border border-gray-300 rounded-md shadow-sm bg-white text-gray-700 hover:bg-gray-50 transition-colors"
          >
